...
pub struct RequestBeginBlock {
    ...
    pub appHashCurReplay: ::std::vec::Vec<u8>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl RequestBeginBlock {
    ...
    // bytes appHashCurReplay = 5;


    pub fn get_appHashCurReplay(&self) -> &[u8] {
        &self.appHashCurReplay
    }
    pub fn clear_appHashCurReplay(&mut self) {
        self.appHashCurReplay.clear();
    }

    // Param is passed by value, moved
    pub fn set_appHashCurReplay(&mut self, v: ::std::vec::Vec<u8>) {
        self.appHashCurReplay = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_appHashCurReplay(&mut self) -> &mut ::std::vec::Vec<u8> {
        &mut self.appHashCurReplay
    }

    // Take field
    pub fn take_appHashCurReplay(&mut self) -> ::std::vec::Vec<u8> {
        ::std::mem::replace(&mut self.appHashCurReplay, ::std::vec::Vec::new())
    }
}
...
impl ::protobuf::Message for RequestBeginBlock {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                5 => {
                    ::protobuf::rt::read_singular_proto3_bytes_into(wire_type, is, &mut self.appHashCurReplay)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.appHashCurReplay.is_empty() {
            my_size += ::protobuf::rt::bytes_size(5, &self.appHashCurReplay);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.appHashCurReplay.is_empty() {
            os.write_bytes(5, &self.appHashCurReplay)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                "appHashCurReplay",
                |m: &RequestBeginBlock| { &m.appHashCurReplay },
                |m: &mut RequestBeginBlock| { &mut m.appHashCurReplay },
            ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    me\x18\x01\x20\x01(\x0b2\x1a.google.protobuf.TimestampR\x04timeB\x08\xc8\
    \xde\x1f\0\x90\xdf\x1f\x01\x12\x1b\n\x08chain_id\x18\x02\x20\x01(\tR\x07\
    ...
    \x18\x04\x20\x01(\x08R\x05proveB\0:\0\"\xc7\x02\n\x11RequestBeginBlock\
    ...
    .EvidenceR\x13byzantineValidatorsB\x04\xc8\xde\x1f\0\x12,\n\x10appHashCu\
    rReplay\x18\x05\x20\x01(\x0cR\x10appHashCurReplayB\0:\0\"^\n\x0eRequestC\
    ...
    2\x1c.tendermint.abci.types.EventR\x06eventsB\x18\xc8\xde\x1f\0\xea\xde\
    \x1f\x10events,omitempty:\0\"\x97\x02\n\x0fResponseCheckTx\x12\x14\n\x04\
    code\x18\x01\x20\x01(\rR\x04codeB\0\x12\x14\n\x04data\x18\x02\x20\x01(\
    ...
    i.types.EventR\x06eventsB\x18\xc8\xde\x1f\0\xea\xde\x1f\x10events,omitem\
    pty\x12\x1e\n\tcodespace\x18\x08\x20\x01(\tR\tcodespaceB\0:\0\"\x99\x02\
    \n\x11ResponseDeliverTx\x12\x14\n\x04code\x18\x01\x20\x01(\rR\x04codeB\0\
    \x12\x14\n\x04data\x18\x02\x20\x01(\x0cR\x04dataB\0\x12\x12\n\x03log\x18\
    \x03\x20\x01(\tR\x03logB\0\x12\x14\n\x04info\x18\x04\x20\x01(\tR\x04info\
    B\0\x12\x1f\n\ngas_wanted\x18\x05\x20\x01(\x03R\tgasWantedB\0\x12\x1b\n\
    \x08gas_used\x18\x06\x20\x01(\x03R\x07gasUsedB\0\x12N\n\x06events\x18\
    \x07\x20\x03(\x0b2\x1c.tendermint.abci.types.EventR\x06eventsB\x18\xc8\
    \xde\x1f\0\xea\xde\x1f\x10events,omitempty\x12\x1e\n\tcodespace\x18\x08\
    \x20\x01(\tR\tcodespaceB\0:\0\"\xa1\x02\n\x10ResponseEndBlock\x12Y\n\x11\
    validator_updates\x18\x01\x20\x03(\x0b2&.tendermint.abci.types.Validator\
    UpdateR\x10validatorUpdatesB\x04\xc8\xde\x1f\0\x12`\n\x17consensus_param\
    _updates\x18\x02\x20\x01(\x0b2&.tendermint.abci.types.ConsensusParamsR\
    \x15consensusParamUpdatesB\0\x12N\n\x06events\x18\x03\x20\x03(\x0b2\x1c.\
    tendermint.abci.types.EventR\x06eventsB\x18\xc8\xde\x1f\0\xea\xde\x1f\
    \x10events,omitempty:\0\"O\n\x0eResponseCommit\x12\x14\n\x04data\x18\x02\
    \x20\x01(\x0cR\x04dataB\0\x12%\n\rretain_height\x18\x03\x20\x01(\x03R\
    \x0cretainHeightB\0:\0\"\xdc\x01\n\x0fConsensusParams\x12:\n\x05block\
    ...
    DurationR\x0emaxAgeDurationB\x08\xc8\xde\x1f\0\x98\xdf\x1f\x01:\0\"9\n\
    ...
    \xea\xde\x1f\x14attributes,omitempty:\0\"\x82\x05\n\x06Header\x12>\n\x07\
    version\x18\x01\x20\x01(\x0b2\x1e.tendermint.abci.types.VersionR\x07vers\
    ionB\x04\xc8\xde\x1f\0\x12&\n\x08chain_id\x18\x02\x20\x01(\tR\x07chainId\
    B\x0b\xe2\xde\x1f\x07ChainID\x12\x18\n\x06height\x18\x03\x20\x01(\x03R\
    ...
    mpR\x04timeB\x08\xc8\xde\x1f\0\x90\xdf\x1f\x01\x12.\n\x12total_voting_po\
    wer\x18\x05\x20\x01(\x03R\x10totalVotingPowerB\0:\0*%\n\x0bCheckTxType\
    \x12\x07\n\x03New\x10\0\x12\x0b\n\x07Recheck\x10\x01\x1a\0B\x1c\xc8\xe2\
    \x1e\x01\xd0\xe2\x1e\x01\xe0\xe2\x1e\x01\xc0\xe3\x1e\x01\xf8\xe1\x1e\x01\
    \xb8\xe2\x1e\x01\xa8\xe2\x1e\x01b\x06proto3\
";
